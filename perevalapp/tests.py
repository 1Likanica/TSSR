...
class MountApiTestCase(APITestCase):
    ...
    def setUp(self):
        user_1 = Authors.objects.create(email='Test_1', phone=1111, fam='Test_1', name='Test_1', otc='Test_1')
        user_2 = Authors.objects.create(email='Test_2', phone=2222, fam='Test_2', name='Test_2', otc='Test_2')
